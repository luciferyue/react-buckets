...
const MARK = "__gat_mobile_root__";
...
export function render(node: ReactElement, container: ContainerType): void {
...
export function unmount(container: ContainerType): any {
	if (createRoot as unknown) {
